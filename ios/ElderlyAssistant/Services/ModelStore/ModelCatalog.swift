...
enum ModelCatalog {
    ...
    /// whose free tier ended 2026-06-30. "HEY SAHAYAK" needs NO retraining:
    ...
    static let all: [ModelCatalogEntry] = [
        ...
        // contains the runtime "HEY SAHAYAK" token line only.
        //
        ...
        ModelCatalogEntry(
            ...
            kind: .kws,
            displayName: "Wake word — Hey Sahayak (sherpa-onnx)",
