...
/// (`WeatherTool`, `SearchTool`), mirroring `GeminiTransport` in
/// `GeminiClient.swift`: tests inject a stub transport and the tool code
/// never touches `URLSession` directly.
///
