...
enum YouTubeRoute {
    ...
    /// लगाऊ-family added on device evidence (2026-09-11): the user's
    /// natural verb for "play a video" is लगाऊ, nasalized by Whisper to
    /// लगाउँ ("युट्युबमा नेपाली न्युज लगाउँ") or लगाऊँ ("युट्युबमा
    /// नेपाली समाचार लगाऊँ") — the hortative ऊँ twin must be listed
    /// next to every ऊ form, in every family (चलाऊँ/बजाऊँ/लगाऊँ and
    /// the -देऊँ imperatives likewise).
