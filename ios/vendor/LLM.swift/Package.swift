...
let package = Package(
    ...
    dependencies: [
        ...
        // swift-testing removed (elderly-ai-assistant vendor): pulled @main
        // which demands Swift tools 6.3; Xcode 16.2 ships 6.0. Only used by
        // LLM's own tests, which the app never builds.
    ],
    targets: [
        .binaryTarget(
            name: "llama",
