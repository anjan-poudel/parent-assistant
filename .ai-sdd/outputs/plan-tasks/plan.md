...
TG-11 (Linguistic Robustness, T-061–T-069) and TG-13 (Environment Robustness Benchmark, T-080–T-089) are drafted in parallel worktrees and are not in this tree, so they are **not** in the total above. Their IDs are reserved; when either lands, its row is added here and the total is recounted from disk rather than propagated.
