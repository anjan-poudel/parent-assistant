...
> **In-flight groups not counted in this worktree's totals.** TG-11 (Linguistic Robustness, **T-061–T-068**) and TG-12 (Crux-Resolution Pipeline, **T-069–T-079**) are being authored in their own worktrees and are not present in this checkout, so their tasks are not in the counts above and their IDs are reserved. TG-13's IDs start at **T-080** for that reason — the brief that scoped it assumed T-063 was free, and it is not. When TG-11/TG-12 land, the counts above must be recounted from disk rather than added to, per the TG-10 convention (`specs/TG-10-notes.md`).
