...
ROWS: list[dict] = [
    ...
    row("fx-ack-dev", "औषधि खाइसकें", "ack_med", "devanagari", "teacher:devanagari",
        medication="औषधि", confidence=0.9),
    ...
    row("fx-none-dev", "हँ", "none", "devanagari", "teacher:devanagari",
        confidence=0.2),
    ...
    row("fx-correction", "होइन, फोन नै गर", "call", "devanagari",
        ...
        confidence=0.9),
    # --- edge families ----------------------------------------------------
    row("fx-abstain-edge", "फोन... अरे होइन... के गर्ने भनेको थिएँ", "none",
    ...
    row("fx-conflict-a", "अहो", "none", "devanagari", "teacher:devanagari",
        confidence=0.2),
    row("fx-conflict-b", "अहो", "query", "devanagari", "teacher:devanagari",
        confidence=0.8),
    ...
    row("fx-health-dev", "सुगर कति हुँदा ठीक हुन्छ", "health_query", "devanagari",
        "teacher:devanagari", confidence=0.8),
