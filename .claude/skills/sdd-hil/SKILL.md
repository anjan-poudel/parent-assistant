...
1. Run `ai-sdd hil list --json --project /Users/anjan/workspace/projects/elderly-ai-assistant` to fetch pending items.
...
4. Ask the user what to do with each item:
   - **Show details**: `ai-sdd hil show <id> --project /Users/anjan/workspace/projects/elderly-ai-assistant`
   - **Approve**: `ai-sdd hil resolve <id> --project /Users/anjan/workspace/projects/elderly-ai-assistant`
     - Optionally add notes: `--notes "approval notes here"`
   - **Reject**: `ai-sdd hil reject <id> --reason "<reason>" --project /Users/anjan/workspace/projects/elderly-ai-assistant`
   - **Skip**: move to the next item

5. After processing, run `ai-sdd hil list --json --project /Users/anjan/workspace/projects/elderly-ai-assistant` again
...
Example: `ai-sdd hil --feature my-feature list --json --project /Users/anjan/workspace/projects/elderly-ai-assistant`
