...
1. Run `ai-sdd status --next --json --project /Users/anjan/workspace/projects/elderly-ai-assistant` via Bash to find the
   ...
   `ai-sdd status --json --project /Users/anjan/workspace/projects/elderly-ai-assistant` — the workflow may be complete
...
3. After the subagent returns, run `ai-sdd hil list --json --project /Users/anjan/workspace/projects/elderly-ai-assistant`.
   If any PENDING HIL items:
   - Show the item context to the developer.
   - Ask: "Approve to continue? [yes/no]"
   - On yes: run `ai-sdd hil resolve <id> --project /Users/anjan/workspace/projects/elderly-ai-assistant`.
   - On no:  run `ai-sdd hil reject <id> --reason "<reason>" --project /Users/anjan/workspace/projects/elderly-ai-assistant`.

4. Run `ai-sdd status --metrics --project /Users/anjan/workspace/projects/elderly-ai-assistant` and show the updated table.
