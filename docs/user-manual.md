...
— as a phone-friendly, bilingual guide (it follows the app's language setting: Nepali in
Nepali, English otherwise). This document is the English source of truth for that content.
